...
import anurag.com.navdrawer.Fragment.ViewPendingReqFragment;
...
//        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.qc, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.sign_out) {
            Intent intent = new Intent(QCActivity.this,LoginActivity.class);
