...
import anurag.com.navdrawer.Fragment.AddStyleFragment;
...
//        });
        ...
        text.setText("Technical Designer");
...
//        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.sign_out) {
            ...
            Intent intent = new Intent(Tech.this,LoginActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_style)
        {
            ...
            transaction.replace(R.id.frame_container,addStyleFragment).commit();

        }
        else if (id == R.id.pps_trail)
        {
