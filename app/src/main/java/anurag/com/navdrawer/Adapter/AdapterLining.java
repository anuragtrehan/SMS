 ...
 */
public class AdapterLining extends BaseAdapter {
    Context context;
    List<AddStyle> addStyle;

    public AdapterLining(List<AddStyle> addStyle, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        code.setText(addStyle1.getL_code());
        width.setText(addStyle1.getL_width());
        consumption.setText(addStyle1.getL_consumption());
        return convertView;
    }
}
